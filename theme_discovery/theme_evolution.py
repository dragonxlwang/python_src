...
def dumpGraphFile(citMatrixFilePath, topicSummaryFilePath, edgeWeightThreshold, noSingleton=True, noBackwardEdge=True):
    citMatrix = proj_theme_discovery.citation_based_method.readCitMatrixSummary(citMatrixFilePath);
    topicSummaryDict = proj_theme_discovery.citation_based_method.readTopicSummary(topicSummaryFilePath);
...
#    citMatrixFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_500_145317_145317_0.001_0.001_timeCtrl_30_45.lda_citMatrix');
#    topicSummaryFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_500_145317_145317_0.001_0.001_timeCtrl_30_45.lda_summary');
...
#    dumpVenRankingFile(topicSummaryFilePath);
    ...
    print('citation-100');
    topicSummaryFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_100_145317_145317_0.001_0.001_timeCtrl_10_24.lda_summary');
    printVenEntropy(topicSummaryFilePath);
    topicSummaryFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_100_145317_145317_0.001_0.001_timeCtrl_2_2.lda_summary');
    printVenEntropy(topicSummaryFilePath);
    ...
    printVenEntropy(topicSummaryFilePath);
    topicSummaryFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_100_145317_145317_1e-06_1e-06_timeCtrl_2_2.lda_summary');
    printVenEntropy(topicSummaryFilePath);
    print('citation-300');
    topicSummaryFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_300_145317_145317_0.001_0.001_timeCtrl_30_45.lda_summary');
    printVenEntropy(topicSummaryFilePath);
    topicSummaryFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_300_145317_145317_0.001_0.001_timeCtrl_40_50.lda_summary');
    printVenEntropy(topicSummaryFilePath);
    print('citation-500');
    topicSummaryFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_500_145317_145317_0.001_0.001_timeCtrl_10_10.lda_summary');
    printVenEntropy(topicSummaryFilePath);
    topicSummaryFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_500_145317_145317_0.001_0.001_timeCtrl_30_45.lda_summary');
    printVenEntropy(topicSummaryFilePath);
    topicSummaryFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_500_145317_145317_0.001_0.001_timeCtrl_40_50.lda_summary');
    printVenEntropy(topicSummaryFilePath);
    topicSummaryFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_500_145317_145317_0.001_0.001_timeCtrl_40_50.lda_summary');
    printVenEntropy(topicSummaryFilePath);
    topicSummaryFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_citation_lda', 'pubmed_citation_lda_500_145317_145317_0.001_0.001_timeCtrl_50_50.lda_summary');
    printVenEntropy(topicSummaryFilePath);
    
    print('content');
    topicSummaryFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_content_title_lda', 'pubmed_content_title_lda_100_317975_22312_0.001_0.001_timeCtrl_12_12.lda_summary');
    printVenEntropy(topicSummaryFilePath);
    topicSummaryFilePath = os.path.join(toolkit.variables.RESULT_DIR, 'pubmed_content_title_lda', 'pubmed_content_title_lda_500_317975_22312_0.001_0.001_timeCtrl_12_12.lda_summary');
    printVenEntropy(topicSummaryFilePath);
